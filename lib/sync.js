    ...
    for (const p of m.players || []) {
      ...
      await trx
        ...
        .values({
          ...
          observer_kills: p.observer_kills ?? null,
          sentry_kills: p.sentry_kills ?? null,
          // purchase.ward_sentry is absent when no sentries were bought; for a
          // parsed match (obs_placed present) treat that as 0, not unknown.
          sentry_bought:
            p.obs_placed != null ? (p.purchase?.ward_sentry ?? 0) : null,
